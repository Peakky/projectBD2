...
import com.example.projectbd2.Courier.Courier;
import com.example.projectbd2.Courier.Courier_Property;
...
public class Courier_Controller implements Initializable {
    ...
    public void updateTable() throws SQLException {
        ...
        result.forEach((p) -> {
            ...
            cp.setId(Integer.toString(p.getCourierID()));
            cp.setNama(p.getNama());
            cp.setNo_telp(p.getNo_telp());
