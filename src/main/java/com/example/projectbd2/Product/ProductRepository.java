...
public class ProductRepository {
    private Connection conn;
        ...
        public void insertData(String Nama, int JumlahProduct, int SupplierID) throws SQLException {
            String Query = "INSERT INTO Product (Nama_Product,Jumlah_Product,SupplierID) VALUES (?,?,?)";
        ...
        public void updateData(int id,String Nama, int JumlahProduct, int SupplierID) throws SQLException {
